...
// Setup payment_settings table
export const setupPaymentSettings: RequestHandler = async (_req, res) => {
  try {
    ...
    res.json({
      success: true,
      message: 'Payment settings table created and initialized successfully'
    });
  } catch (error) {
