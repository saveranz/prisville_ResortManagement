-- ============================================
-- RAILWAY FINAL: Complete Setup
-- Run this entire script on Railway
-- ============================================

-- STEP 1: Add archived column to walk_in_bookings
ALTER TABLE walk_in_bookings 
ADD COLUMN archived TINYINT(1) DEFAULT 0 AFTER payment_status;

-- STEP 2: Insert walk-in room bookings (8 records)
INSERT INTO walk_in_bookings (guest_name, room_number, address, contact_number, number_of_pax, amount, total_amount, down_payment, balance, payment_status, archived, created_at) VALUES 
...
-- STEP 3: Insert day pass walk-ins (24 records)
...
SELECT * FROM walk_in_bookings WHERE archived = 0 ORDER BY created_at DESC LIMIT 3;
SELECT * FROM day_pass_walk_in ORDER BY created_at DESC LIMIT 3;
